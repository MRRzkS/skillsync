  ...
  return (
    <div className="sticky top-8 hidden rounded-2xl border border-ocean-100/70 bg-white p-5 shadow-card lg:block">
      ...
      <p className="font-candidate-heading text-lg font-bold text-text-dark">
        {wizard.personal.fullName || "Your Name"}
      </p>
      ...
      <div className="mt-4 grid grid-cols-2 gap-2 text-center">
        <div className="rounded-lg bg-ocean-50/60 py-2">
          ...
          <p className="text-[10px] uppercase tracking-wide text-text-gray">Experience</p>
        </div>
        <div className="rounded-lg bg-sync-purple-50 py-2">
          ...
          <p className="text-[10px] uppercase tracking-wide text-text-gray">Education</p>
        </div>
      </div>
        ...
        <div className="rounded-2xl border border-ocean-100/60 bg-white p-6 shadow-card lg:p-8">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3 border-t border-ocean-100/70 pt-5">
            ...
            <Button variant="ghost" onClick={handleGenerateAnother} className="gap-2">
              <RefreshCcw className="h-4 w-4" /> Generate Another CV
            </Button>
          </div>
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2">
        ...
        <h1 className="font-candidate-heading text-xl font-bold text-text-dark">Build your CV</h1>
      </div>
      <p className="mt-2 max-w-xl text-sm leading-relaxed text-text-gray">
        A few short steps — no jargon, no JSON, just your story.
      </p>
            ...
            {isReviewStep ? (
              ...
              >
                {saveStatus === "saving" ? (
                  ...
                  <>
                    Save &amp; Generate CV <ArrowRight className="h-4 w-4" />
                  </>
                )}
              </Button>
            ) : (
